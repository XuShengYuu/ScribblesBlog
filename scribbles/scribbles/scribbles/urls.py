...
urlpatterns = [
    ...
    re_path(r'^api/docs/', include_docs_urls(title='scribbles apis')),
    re_path(r'^sitemap\.xmls$', cache_page(60*20, key_prefix='sitemap_cache_')
    (sitemap_views.sitemap),{'settings':{'posts':PostSitemap}}),
